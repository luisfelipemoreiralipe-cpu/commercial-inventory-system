...
export default function CommercialAgreements() {
  ...
  return <Page>
    <Header><div><Title>Acordos e bonificacoes</Title><Hint>As compras elegiveis acumulam por nota fiscal. O valor fiscal da bonificacao fica separado do beneficio comercial real.</Hint></div>
